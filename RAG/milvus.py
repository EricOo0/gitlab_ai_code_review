...
class VectorStore:
    ...
    def create_collection(self, collection_name):
        ...
        embedding_field = FieldSchema(name="vector", dtype=DataType.FLOAT_VECTOR, dim=5, description="vector")
        ...
        self.client.create_collection(
                ...
                dimension=5,  # The vectors we will use in this demo has 768 dimensions
                schema=schema
            )
    ...
    def query(self,collection, query_vectors):
